    ...
    >
      ...
      <section className="mx-auto max-w-3xl rounded-[28px] border border-zinc-200/80 bg-white/85 p-8 shadow-[0_20px_60px_-24px_rgba(35,52,20,0.35)] backdrop-blur sm:p-10">
        ...
        <p className="mt-5 max-w-2xl text-base leading-relaxed text-zinc-700 sm:text-lg">
          {t("Shamba Online helps small farms plan, track, and improve day-to-day farm work in one place.")}
        </p>
        ...
        <div className="mt-7 rounded-2xl border border-zinc-200 bg-zinc-50/80 p-5">
          ...
          <ul className="mt-3 space-y-2.5 text-sm text-zinc-700 sm:text-base">
            <li>{t("Organize crops, trees, zones, and farm systems")}</li>
            <li>{t("Track tasks, work hours, and harvest activity")}</li>
            <li>{t("Monitor soil, compost, and seedling progress over time")}</li>
          </ul>
        </div>
        ...
        <div className="mt-8 flex flex-wrap gap-3">
          ...
          <Link
            href="/signup"
            className="inline-flex items-center justify-center rounded-2xl border border-zinc-300 bg-white px-7 py-4 text-base font-semibold text-zinc-900 transition hover:-translate-y-0.5 hover:bg-zinc-50 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-emerald-500 focus-visible:ring-offset-2"
          >
            {t("Create your farm")}
          </Link>
        </div>
